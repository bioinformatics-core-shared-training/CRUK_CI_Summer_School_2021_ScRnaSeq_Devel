...
```{r example_load}
sample.path <- "CourseMaterials/CellRanger_Outputs/SRR9264343/outs/raw_feature_bc_matrix/"
...
list_of_files <- samplesheet %>%
    ...
    slice(1:2) %>%
    mutate(File=str_c("CourseMaterials/CellRanger_Outputs/", 
                      Sample,
...
saveRDS(sce, "CourseMaterials/results/sce_pooled_samples.rds")
```


```{r dataSets_readRds, echo=FALSE, eval=FALSE}
sce <- readRDS("CourseMaterials/results/sce_pooled_samples.rds")
```
...
saveRDS(sce, "CourseMaterials/results/sce_pooled_samples_annot.rds")
```


```{r dataSets_readRds2, echo=FALSE, eval=FALSE}
sce <- readRDS("CourseMaterials/results/sce_pooled_samples_annot.rds")
```
...
```{r sparsity_split}
sce.caron <- sce[,sce$setName=="Caron"]
```
