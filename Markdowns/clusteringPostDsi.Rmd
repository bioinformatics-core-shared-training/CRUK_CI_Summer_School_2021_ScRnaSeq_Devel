...
```{r plot_tsne_hierar_facet, fig.width=2*5, fig.height=ceiling(nlevels(droplevels(sce$source_name))/2)*5}
...
```{r plot_tSNE_kmeans_k6_split, fig.width=2*5, fig.height=ceiling(nlevels(droplevels(sce$source_name))/2)*5}
...
```{r show_louvain_tsne_2, fig.width=2*5, fig.height=ceiling(nlevels(droplevels(sce$source_name))/2)*5}
...
```{r show_leiden_tsne_2, fig.width=2*5, fig.height=ceiling(nlevels(droplevels(sce$source_name))/2)*5}
# facet by sample group:
p + facet_wrap(~ sce$source_name)
```
...
```{r, fig.width=2*5, fig.height=ceiling(nlevels(droplevels(sce$source_name))/2)*5}
 # ```{r, out.width = '100%'}
