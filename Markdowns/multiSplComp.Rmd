...
```{r multiSplComp_setup, include=FALSE, echo=FALSE, dev="CairoPNG"}
...
##tmpFn <- str_glue("{projDir}/{outDirBit}/Robjects/{setName}_postDeconv{setSuf}{dsiSuf}_{splSetToGet2}_Fmwbl.Rds")
tmpFn <- "../CourseMaterials/Robjects/DataIntergration_mnn.out.rds"
print(tmpFn)
...
The steps illustrated above with cluster `r labelToGet` are now repeated for each cluster:
