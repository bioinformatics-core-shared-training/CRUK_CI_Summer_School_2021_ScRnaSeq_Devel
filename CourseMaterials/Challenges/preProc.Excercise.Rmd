...
plotColData(sce, 
        ...
        guides(colour=guide_legend(title="High % mitochrondrial"))
```

# Considering experimental factors when filtering

Based on the experimental design and the plots above, do you think applying the
adaptive filtering across all the samples is appropriate?
